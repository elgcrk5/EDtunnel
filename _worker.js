...
<img src="https://upload.wikimedia.org/wikipedia/commons/a/a9/Seal_of_the_City_of_Surakarta.svg" style="width: 50%">
        <br>
        <font color="#fff300">
        ...
        <p class="kata3"></p>
        <marquee>
            <b style="color: white;font-size: 18px">.:: </b> 
            <b style="color: Red;font-size:30px">𒆜 VLESS LIFETIME FREE DILARANG MEMPERJUAL BELIKAN 𒆜</b> 
            <b style="color: white;font-size: 18px"> ::.</b>
</marquee>
</center>
</body>
