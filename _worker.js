...
function getวเลสConfig(userIDs, hostName) {
	const commonUrlPart = `:443?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D2048#Uzumaki`;
	const hashSeparator = "################################################################";
...
<b style='font-size: 15px;'>ㄒ乇ㄥ乇Ꮆ尺卂爪 http://t.me/eruoone:</b>
  ...
  <head>
	...
	<meta property='og:site_name' content='Uzumaki: Vless' />
	<meta property='og:type' content='website' />
	<meta property='og:title' content='Uzumaki - Vless configuration and subscribe output' />
